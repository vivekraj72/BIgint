...
{
private:
    string str; // only data memeber for strict Big Integer as String. [For signed int, str[0] = '-']
    ...
    static string pow(string, std::string);
...
public:
    ...
    {
        bigint ans;
        ans.str = multiply(str, to_string(n2));
        return ans;
    }
    ...
    {
        bigint ans;
        ans.str = divide(str, std::to_string(n2));
        return ans;
    }
    friend bigint operator/(long long int n1, bigint const &n2)
    {
    ...
    {
        return is_strictlyMaximum(str, std::to_string(n2));
    }
    ...
    bool operator<(long long int n2)
    {
        return is_strictlyMinimum(str, std::to_string(n2));
    }
    ...
    bool operator>=(long long int n2)
    {
        return is_maximum(str, std::to_string(n2));
    }
    friend bool operator>=(long long int n1, bigint const &n2)
    {
    ...
    bool operator<=(long long int n2)
    {
        return is_minimum(str, std::to_string(n2));
    }
    friend bool operator<=(long long int n1, bigint const &n2)
    {
...
string bigint::reverse(std::string s)
...
string bigint::lcm(string str1, std::string str2)
